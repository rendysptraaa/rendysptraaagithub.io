  ...
  <section id="login" class="section-margin" style="margin-bottom: 100pt;">
    ...
    <div class="row content" id="login">
      <div class="col-lg-12 danger text-center zero-panel">
        ...
        <br><br>
        <a href="petugas/login_petugas.php" target="_blank"><button class="btn btn-warning"
            style="size: 50px;">PETUGAS</button></a>
      ...
      <div class="col-lg-12 danger text-center zero-panel">
        <div class="col-lg-12 zero-panel-content">
          <div class="jumbotron">
            ...
            <p>Website inventory adalah aplikasi berbasis Web untuk mengatur dan mencatat keluar masuk barang dalam satu Toko Smartphone, yang meliputi pencatatan barang masuk dari Supplier dan pencatatan barang keluar. </p>
          </div>
    ...
    <section class="col-sm-12" style="margin-top: 50px;">
      <div class="col-lg-10 col-lg-offset-1 text-center">
        ...
        <ul class="list-inline">
          <li>
            <a href="https://www.facebook.com/share/X7yjcksdprxfijAN/" target="_blank"><i
                class="fa fa-facebook fa-fw fa-2x"></i></a>
          </li>
          <li>
            <a href="https://www.instagram.com/rendysptraa._/" target="_blank"><i
                class="fa fa-instagram fa-fw fa-2x"></i></a>
          </li>
          <li>
            <a href="https://www.linkedin.com/in/rendy-saputra/" target="_blank"><i
                class="fa fa-linkedin fa-fw fa-2x"></i></a>
          </li>
        </ul>
        <hr class="medium">
        <p class="text-muted" style="font-size: 16px;">Copyright &copy;
          <script>document.write(new Date().getFullYear());</script> Rendi Saputra All rights reserved
        </p>
      </div>
    </section>
  </footer>
